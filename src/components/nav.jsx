  ...
  return (
    <div className="flex justify-between items-center px-20 py-6">
      ...
      <div className="flex gap-8">
        <a href='#' className="text-white text-lg font-medium font-Poppins hover:text-sky-300 hover:shadow-sky-400 transition-all ease-in">Contact us</a>
        <a href='#' className="text-white text-lg font-medium font-Poppins hover:text-sky-300 hover:shadow-sky-400 transition-all ease-in">Home</a>
        <a href='#' className="text-white text-lg font-medium font-Poppins hover:text-sky-300 hover:shadow-sky-400 transition-all ease-in">About</a>
      </div>
